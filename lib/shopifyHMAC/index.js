...
exports.extractShopifySignature = extractShopifySignature;

const constructShopifySignature = (req, options) =>
  calculateHmacParam({
...
exports.constructShopifySignature = constructShopifySignature;
